...
<div class="csp-wrap csp-welcome-wrap">
	<div class="csp-header-wrap">
		<div class="csp-header-logo-title">
			<img class="csp-logo"
			     width="50px"
			     src="<?php echo esc_url( 'https://codesnippets.pro/wp-content/uploads/2023/11/code-snippets-pro-logo80h-copy-1.png' ); ?>"
		...
		<ul class="csp-list-header-nav">
			<li>
				<?php
				printf(
                    '<a href="%s" class="csp-link-nav csp-link-cloud">
			...
			<li>
				<?php
				printf(
                    '<a href="%s" class="csp-link-nav csp-link-resources">
                            <div class="csp-link-text">
                                <span class="csp-link-text-top">%s</span>
                            </div>
			...
			<li>
				<?php
				printf(
                    '<a href="%s" class="csp-link-nav csp-link-community">
                            <div class="csp-link-text">
                                <span class="csp-link-text-top">%s</span>
                            </div>
			...
			<li>
				<?php
				printf(
                    '<a href="%s" class="csp-link-nav csp-link-pro">
                            <div class="csp-link-text">
                                <span class="csp-link-text-top">%s</span>
                            </div>
